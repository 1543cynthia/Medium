...
//設定地形、擺上主角
$(function(){
    mapArray=[//0-可走,1-障礙,二-終點,3-敵人
        [0,1,1],
        [0,0,0],
        [3,1,2]
    ];
    ctx=$("#myCanvas")[0].getContext("2d")//mycanvas是畫布 getcontext是內容
    //初始化
    imgMain = new Image();
    ...
    imgMain.onload = function(){//0,0,80,130 圖片裡找座標剪下來   gridLength,gridLength寬， 高
